...
input="${SCRATCH}/projects/crystal_fem/solidfe/hcp-bcc/${model}/bcc_constants.txt"
...
for n in "${!T[@]}"
do
  folderpath="${SCRATCH}/projects/crystal_fem/solidfe/hcp-bcc/${model}/frenkel_ladd_T_${T[n]}_P_${P[n]}_k_${k[n]}_a_${a[n]}/"
