...
# Run at experimental temperature for BCC-liquid coexistence
T=("1940.52" "1979.41" "2011.3"  "2041.43" "2071.56" "2092.93")
P=(0 1 2 3 4 5)

# input="../../../juwels/output/bcc-liquid/titanium__MACE_r_cutoff_0.5_2025_5_4_21abc4af-aea1-4549-a9a5-981f6324c2e5/bcc_constants.txt"
...
do
  ...
  lmp       -in lammps/create_bcc_box.lmp  \
